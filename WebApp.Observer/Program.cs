...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        {
            UserObserverSubject userObserverSubject = new UserObserverSubject();
            ...
            userObserverSubject.RegisterObserver(new UserObserverSendEmail(sp, builder.Configuration));
